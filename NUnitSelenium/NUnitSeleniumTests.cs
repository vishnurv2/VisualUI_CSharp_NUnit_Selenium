...
namespace NUnitSelenium
{
    ...
    public class NUnitSeleniumSample
    {
        ...
        public void Init()
        {
            ...
            //Smart UI Project to be created beforehand from the Visual-UI Dashboard.
        ...
        {
            {
                ...
                // The following text value can be changed after the first test run to view visual changes on the Visual UI Dashboard
                driver.Value.FindElement(By.Id("sampletodotext")).SendKeys("Yey, Let's add it to the list");
